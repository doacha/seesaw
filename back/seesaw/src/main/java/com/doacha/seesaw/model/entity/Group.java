...
public class Group {
    ...
    @Column(name = "group_period", nullable = false)
    @Schema(description = "미션 횟수", example = "4", required = true)
    private int groupPeriod;

    @Column(name = "group_cycle", nullable = false)
