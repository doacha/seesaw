...
import { getCycleTerm, getTimeBefore } from '@/app/(mission)/util'
import { text } from 'stream/consumers'
import BoardSpendingHistory from './BoardSpendingHistory'
...
const BoardContentContainer = (/*{ data }: { data: boardDetailProps }*/) => {
